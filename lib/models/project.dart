...
final List<Project> portfolioProjects = [
  ...
  Project(
    ...
    shortDescription: 'AI-powered learning app for children with voice recognition, 3D animations, and interactive tracing modules.',
    
    // 📄 DETAIL PAGE - Full description
    fullDescription: '''Developed a fully AI-based learning mobile application for children using Flutter and Dart. This innovative educational platform combines cutting-edge AI technology with engaging interactive content to revolutionize early childhood education.
...
The architecture leverages MobX state management for scalable, clean, and maintainable code. Backend-driven navigation dynamically controls screen flow based on API responses, while SharedPreferences enables offline support for uninterrupted learning. Performance was optimized by minimizing widget rebuilds and lazy-loading assets.''',
    ...
    techStack: ['Flutter', 'Dart', 'REST APIs', 'WebSocket', 'MobX', 'Three.js', 'WebView', 'Rive', 'Lottie', 'CustomPainter'],
    features: [
  ...
  Project(
    ...
    // 📱 CARD (Main Screen)
    shortDescription: 'Multi-role Flutter app with Student, Teacher, Organization, and Admin panels featuring role-based navigation.',
    
    // 📄 DETAIL PAGE
    fullDescription: '''Developed a powerful multi-role Flutter application supporting Student, Teacher, Organization, and Admin panels, each with dedicated role-based UI flows and functionality.
...
Applied Flutter best practices for widget composition, layout optimization, and UI performance, resulting in smooth screen transitions and intuitive user journeys across all different panels.''',
    ...
    heroImage: 'assets/images/project_isoar_hero.png',
    galleryImages: [
      'assets/images/project_isoar_1.png',
      'assets/images/project_isoar_2.png',
      'assets/images/project_isoar_3.png',
    ],
    techStack: ['Flutter', 'Dart', 'GetX', 'Clean Architecture', 'Responsive UI'],
    features: [
  ...
  Project(
    ...
    // 📱 CARD (Main Screen)
    shortDescription: 'Fashion e-commerce app with barcode scanning, real-time messaging, and Firebase integration for expo buyers.',
    
    // 📄 DETAIL PAGE
    fullDescription: '''Developed a feature-rich role-based Flutter mobile application tailored for the fashion industry, supporting Customer, Designer, and Admin user models, each with dedicated functionality and unique UI flows.
...
Ensured real-time data updates using Firebase Firestore, providing a seamless and responsive user experience. Developed following clean UI principles and performance optimization best practices using Provider state management.''',
    ...
    heroImage: 'assets/images/project_lookbook_hero.png',
    galleryImages: [
      'assets/images/project_lookbook_1.png',
      'assets/images/project_lookbook_2.png',
      'assets/images/project_lookbook_3.png',
    ],
    techStack: ['Flutter', 'Dart', 'Provider', 'Firebase Auth', 'Firestore', 'FCM', 'Barcode Scanner'],
    features: [
